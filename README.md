...
<h1 style ="size: 40px">The Overview of the Project </h1>

<h1 style ="style: 30px">THE HOME PAGE</h1>
...
Authentication is here handled using passport and passport local libraries.The register and login pages are set up differently and the user has to get authenticated to access his / her login page
 ...
 <h1 style = "size: 25px">1.1) Register ( with random details)</h1>
     
  ![register](https://user-images.githubusercontent.com/78142846/125283471-154c6780-e336-11eb-918c-56ecdf694766.png)
       
 <h1 style = "size: 25px">1.2) Login </h1>
      
 <h1 style = "size: 20px">1.2.1) Login with wrong email </h1>
 ...
 <h1 style = "size: 20px">1.2.2) Login with wrong password</h1>
 ...
 <h1 style = "size: 20px">1.2.3) Login with correct credentials</h1>
...
<h1 style ="size:30px">2) Individual Profile Page </h1>
 ...
 <h1 style = "size:25px">2.1) The meeting area </h1>
 ...
 <h1 style = "size:25px">2.2) The Profile section </h1>
...
<h1 style ="size:30px"> 3) Video Call Page </h1>
 
   <h1 style ="size:25px">3.1) The control Panel</h1>
   ...
   <h1 style ="size:20px">3.1.1)  The Invite People button</h1>
   ...
   <h1 style ="size:20px">3.1.2)  The Mute (and Unmute) Button</h1>
  ...
  <h1 style ="size:20px">3.1.3). The stop (and PLay video) Button</h1>
   ...
   <h1 style="size:20px">3.1.4) The End Call simply removes the user from the call and directs it back to the profile page</h1>

  <h1 style ="size:25px">3.2) The Chat box</h1>
  ...
  <h1 style ="size:25px">3.3) The Screen Optimisation ( The most exciting feature)</h1>
